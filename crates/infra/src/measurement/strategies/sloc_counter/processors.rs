...
pub use hash_style::{
    process_perl_style, process_python_style, process_ruby_style, process_simple_hash_style,
};
...
pub use other_styles::{
    process_batch_style, process_erlang_style, process_fortran_style,
    process_haskell_style, process_lisp_style,
    process_lua_style, process_matlab_style, process_visual_basic_style,
};
